	...
	public class Slash2 : PlayerWeaponAttack {
		...
		public override void OnRoutine() {
			if (step == 0 && isProgress(0.2f)) {
				...
				GameObject obj = UObjectPool.instance.Get("SlashEffect", (Vector2)player.transform.position + new Vector2(0.3f*(player.lookingLeft?-1:1)+Random.Range(-0.1f, 0.1f),-0.1f+Random.Range(-0.1f, 0.1f)));
